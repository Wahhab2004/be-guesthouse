...
const createGuest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, email, username, phone, password, passport, dateOfBirth, gender, country, } = req.body;
    ...
    try {
        ...
        const hashedPassword = !isLoggedIn && password ? yield bcrypt_1.default.hash(password, 10) : null;
...
const updateGuest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { name, email, username, phone, password, passport, dateOfBirth, country, } = req.body;
    try {
